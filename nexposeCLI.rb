...
$list = Array.new
$options = {:username => nil, :password => nil, :ip => nil, :ip_list => nil, :site => nil, :engine => 1, :console => '127.0.0.1', :engine_list => nil, :site_list => nil, :name => nil, :creds => nil, :remove_assets => nil}
